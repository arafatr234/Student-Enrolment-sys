  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{(URL::to('/studentlogin'))}}">
         <p style="font-size:30px;color:Black;padding-top:20px;">Student</p>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
               ...
               <a class="nav-link" href="{{URL::to('/student_viewprofile')}}">
