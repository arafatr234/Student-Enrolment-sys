            ...
            <div class="col-lg-12 side-left">
              ...
              <div class="card mb-4">
                <div class="card-body avatar">
                  ...
                  <p class="name">{{$teacher_description_profile->teachers_name}}</p>
                  <!-- with er 1st parameter jeta seta dara porobortite amra  show koranor try kore 
                  	thaki -->
                  
                  <a class="email" href="#">${{$teacher_description_profile->teachers_email}}</a>
                  <a class="number" href="#">{{$teacher_description_profile->teachers_phone}}</a>
                </div>
              </div>
              <div class="card mb-4">
                <div class="card-body overview">
                  ...
                  <div class="info-links">
                     ...
                     <a class="website">
                      ...
                      <span style="font-family:vernada;font-size:15px">{{$teacher_description_profile->teachers_address}}</span>
                    </a>
                      </a>
                    <a class="website">
                      <i class="icon-globe icon">Teacher Deratment:</i>
